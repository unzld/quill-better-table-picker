  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        var external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_ =
        ...
        class table_column_tool_TableColumnTool {
          ...
          initColTool() {
            ...
            css(this.domNode, {
              ...
              left: "".concat(
                tableViewRect.left - containerRect.left + parent.scrollLeft,
                "px"
              ),
              top: "".concat(
                tableViewRect.top -
          ...
          updateToolCells() {
            const tableContainer =
              external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.find(
                this.table
              );
            const CellsInFirstRow =
              tableContainer.children.tail.children.head.children;
            ...
            for (
              ...
              let colWidth =
                col && parseInt(col.formats()[col.statics.blotName].width, 10); // if cell already exist
          ...
          addColCellHolderHandler(cell) {
            ...
            const handleDrag = (e) => {
              ...
              if (dragging) {
                ...
                css($helpLine, {
                  left: "".concat(
                    cellRect.left + cellRect.width - 1 + delta,
                    "px"
                  ),
                });
              }
        ...
        const Block =
          external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.import(
            "blots/block"
          );
        ...
        class header_Header extends Block {
            ...
            return CELL_ATTRIBUTES.concat(CELL_IDENTITY_KEYS).reduce(
              (formats, attribute) => {
                if (domNode.hasAttribute("data-".concat(attribute))) {
                  formats[attribute] =
                    domNode.getAttribute("data-".concat(attribute)) ||
                    undefined;
                }
          ...
          format(name, value) {
            const { row, cell, rowspan, colspan } = header_Header.formats(
              this.domNode
            );
          ...
          optimize(context) {
            const { row, rowspan, colspan } = header_Header.formats(
              this.domNode
            );
            ...
            if (this.children.length === 0) {
              if (this.statics.defaultChild != null) {
                const child = this.scroll.create(
        ...
        class TableCellLine extends table_Block {
          static create(value) {
            ...
            CELL_IDENTITY_KEYS.forEach((key) => {
              ...
              node.setAttribute(
                "data-".concat(key),
                value[key] || identityMaker()
              );
            });
            CELL_ATTRIBUTES.forEach((attrName) => {
              node.setAttribute(
                "data-".concat(attrName),
          ...
          formats() {
            return ["row"].reduce((formats, attrName) => {
              if (this.domNode.hasAttribute("data-".concat(attrName))) {
                formats[attrName] = this.domNode.getAttribute(
                  "data-".concat(attrName)
                );
              }
        ...
        class table_TableContainer extends Container {
          ...
          updateTableWidth() {
            setTimeout(() => {
              ...
              const tableWidth = colGroup.children.reduce((sumWidth, col) => {
                sumWidth =
                  sumWidth +
                  parseInt(col.formats()[TableCol.blotName].width, 10);
                return sumWidth;
              }, 0);
          ...
          tableDestroy() {
            const quill =
              external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.find(
                this.scroll.domNode.parentNode
              );
          ...
          insertRow(compareRect, isDown, editorWrapper) {
            ...
            const refRow = this.rows().find((row) => {
              ...
              if (isDown) {
                return (
                  Math.abs(rowRect.y - compareRect.y - compareRect.height) <
                  ERROR_LIMIT
                );
              } else {
          ...
          mergeCells(
            ...
            let cellId =
              mergedCell.children.head.domNode.getAttribute("data-cell");
        ...
        table_TableContainer.className = "quill-better-table-picker";
        ...
        table_TableViewWrapper.className = "quill-better-table-picker-wrapper";
        ...
        class table_selection_TableSelection {
          ...
          mouseDownHandler(e) {
            if (
              e.button !== 0 ||
              !e.target.closest(".quill-better-table-picker")
            )
              return;
            this.quill.root.addEventListener(
              "mousemove",
            ...
            function mouseUpHandler(e) {
              self.quill.root.removeEventListener(
                "mousemove",
                mouseMoveHandler,
                false
              );
            ...
            tableCells.forEach((tableCell) => {
              ...
              let isCellIntersected =
                ((x + table_selection_ERROR_LIMIT >= this.boundary.x &&
                  x + table_selection_ERROR_LIMIT <= this.boundary.x1) ||
                  (x - table_selection_ERROR_LIMIT + width >= this.boundary.x &&
                    x - table_selection_ERROR_LIMIT + width <=
                      this.boundary.x1)) &&
                ((y + table_selection_ERROR_LIMIT >= this.boundary.y &&
                  y + table_selection_ERROR_LIMIT <= this.boundary.y1) ||
                  (y - table_selection_ERROR_LIMIT + height >=
                    this.boundary.y &&
                    y - table_selection_ERROR_LIMIT + height <=
                      this.boundary.y1));
        ...
        var icon_operation_1_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_1);
        ...
        var icon_operation_2_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_2);
        ...
        var icon_operation_3_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_3);
        ...
        var icon_operation_4_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_4);
        ...
        var icon_operation_5_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_5);
        ...
        var icon_operation_6_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_6);
        ...
        var icon_operation_7_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_7);
        ...
        var icon_operation_8_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_8);
        ...
        var icon_operation_9_default =
          /*#__PURE__*/ __webpack_require__.n(icon_operation_9);
          ...
          insertColumnRight: {
            ...
            handler() {
              ...
              let colIndex = getColToolCellIndexByBoundary(
                ...
                (cellRect, boundary) => {
                  return (
                    Math.abs(cellRect.x + cellRect.width - boundary.x1) <=
                    table_operation_menu_ERROR_LIMIT
                  );
                },
                this.quill.root.parentNode
              );
          ...
          insertColumnLeft: {
            ...
            handler() {
              ...
              let colIndex = getColToolCellIndexByBoundary(
                ...
                (cellRect, boundary) => {
                  return (
                    Math.abs(cellRect.x - boundary.x) <=
                    table_operation_menu_ERROR_LIMIT
                  );
                },
                this.quill.root.parentNode
          ...
          mergeCells: {
            ...
            handler() {
              ...
              const rowspan = tableContainer.rows().reduce((sum, row) => {
                ...
                if (
                  rowRect.y >
                    this.boundary.y - table_operation_menu_ERROR_LIMIT &&
              ...
              const colspan = this.columnToolCells.reduce((sum, cell) => {
                ...
                if (
                  cellRect.x >
                    this.boundary.x - table_operation_menu_ERROR_LIMIT &&
          ...
          deleteColumn: {
            ...
            handler() {
              ...
              let colIndexes = getColToolCellIndexesByBoundary(
                ...
                (cellRect, boundary) => {
                  return (
                    cellRect.x + table_operation_menu_ERROR_LIMIT >
                      boundary.x &&
                    cellRect.x +
                      cellRect.width -
                      table_operation_menu_ERROR_LIMIT <
        ...
        class TablePicker extends Picker {
          ...
          buildItem(option) {
            ...
            item.addEventListener("mouseover", () => {
              ...
              let lastItem = this.container.querySelector(
                ".ql-picker-item:last-child"
              );
          ...
          selectItem(item, trigger = false) {
            ...
            Array.from(this.container.querySelectorAll(".hover")).forEach(
              (item) => {
        ...
        /* harmony default export */ var table_picker = TablePicker;
        ...
        class better_table_snow_BetterTableSnowTheme extends SnowTheme {
        ...
        /* harmony default export */ var better_table_snow =
          better_table_snow_BetterTableSnowTheme;
        ...
        function matchTable(node, delta, scroll) {
          ...
          const cellsInTopRow = Array.from(
            topRow.querySelectorAll("td")
        ...
        // CONCATENATED MODULE: ./src/quill-better-table-picker.js
        ...
        const quill_better_table_Delta =
          external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.import(
            "delta"
          );
        ...
        class quill_better_table_BetterTable extends Module {
          ...
          constructor(quill, options) {
            super(quill, options); // handle click on quill-better-table-picker
            ...
            this.quill.root.addEventListener(
              ...
              (evt) => {
                ...
                const tableNode = path.filter((node) => {
                  return (
                    ...
                    node.classList.contains("quill-better-table-picker")
                  );
                })[0];
              ...
              false
            ); // handle right click on quill-better-table-picker
            ...
            quill.keyboard.bindings["Backspace"].splice(0, 1, thisBinding); // add Matchers to match and render quill-better-table-picker for initialization
            // or pasting
            ...
            const input = toolbar.container.querySelector(
              "select.ql-better-table"
            );
          ...
          showTableTools(table, quill, options) {
            this.table = table;
            this.columnTool = new table_column_tool_TableColumnTool(
              table,
              quill,
              options
            );
        ...
        quill_better_table_BetterTable.keyboardBindings = {
          "table-cell-line backspace": {
            ...
            handler(range, context) {
              ...
              return !(
                !line.prev || line.prev.statics.blotName !== "table-cell-line"
              );
            },
          },
        ...
        /* harmony default export */ var quill_better_table =
          (__webpack_exports__["default"] = quill_better_table_BetterTable);
